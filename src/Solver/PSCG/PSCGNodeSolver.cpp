...
#if 0
DSP_RTN_CODE PSCGNodeSolver::createProblem() {
	BGN_TRY_CATCH
...
DSP_RTN_CODE PSCGNodeSolver::initialOsiSolver() {
	BGN_TRY_CATCH
	/** set hint parameters */
	if (useBarrier_) {
...
#if 0
DSP_RTN_CODE PSCGNodeSolver::initialColumns() {
	BGN_TRY_CATCH
...
DSP_RTN_CODE PSCGNodeSolver::solvePhase1() {
	BGN_TRY_CATCH
...
DSP_RTN_CODE PSCGNodeSolver::solvePhase2() {
	BGN_TRY_CATCH
...
DSP_RTN_CODE PSCGNodeSolver::gutsOfSolve() {
...
DSP_RTN_CODE PSCGNodeSolver::solveMaster() {
	BGN_TRY_CATCH
...
DSP_RTN_CODE PSCGNodeSolver::restoreCols() {
...
DSP_RTN_CODE PSCGNodeSolver::reduceCols() {
	BGN_TRY_CATCH
	/** FIXME:
...
DSP_RTN_CODE PSCGNodeSolver::generateCols() {
...
DSP_RTN_CODE PSCGNodeSolver::addCols(
...
DSP_RTN_CODE PSCGNodeSolver::getLagrangianBound(
		std::vector<double>& objs /**< [in] subproblem objective values */) {
	BGN_TRY_CATCH
...
bool PSCGNodeSolver::terminationTest() {
...
DSP_RTN_CODE PSCGNodeSolver::updateModel() {
	BGN_TRY_CATCH
...
DSP_RTN_CODE PSCGNodeSolver::calculatePiA(
...
DSP_RTN_CODE PSCGNodeSolver::preHeuristic(
...
DSP_RTN_CODE PSCGNodeSolver::postHeuristic(
		double*& rlbd,    /**< [out] original row lower bounds */
		double*& rubd,    /**< [out] original row lower bounds */
		double*& primsol, /**< [out] original primal solution */
		double& primobj,  /**< [out] original primal objective */
...
DSP_RTN_CODE PSCGNodeSolver::heuristicTrivial() {
#define FREE_MEMORY \
	FREE_ARRAY_PTR(rlbd) \
	FREE_ARRAY_PTR(rubd) \
...
DSP_RTN_CODE PSCGNodeSolver::heuristicFp(int direction) {
#define FREE_MEMORY \
	FREE_ARRAY_PTR(rlbd) \
	FREE_ARRAY_PTR(rubd) \
	FREE_ARRAY_PTR(primsol_org)
...
DSP_RTN_CODE PSCGNodeSolver::heuristicDive() {
#define FREE_MEMORY \
	FREE_ARRAY_PTR(rlbd) \
	FREE_ARRAY_PTR(rubd) \
	FREE_ARRAY_PTR(primsol_org)
...
DSP_RTN_CODE PSCGNodeSolver::gutsOfDive(
...
void PSCGNodeSolver::setBranchingObjects(const DspBranchPSCG* branchobj) {
	/** shouldn't be null */
	if (branchobj == NULL)
		return;
...
#if 0
DSP_RTN_CODE PSCGNodeSolver::switchToPhase2() {
	BGN_TRY_CATCH
	if (phase_ == 1) {
		/** delete auxiliary columns */
		si_->deleteCols(auxcolindices_.size(), &auxcolindices_[0]);
